...
function Contact() {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_7w2xy2b', 'template_91awceq', form.current, '7_R9roL9I6SBAJwqr')
        e.target.reset()
    };
    return (
                    ...
                    <div className='contact__info'>
                        <div className='contact__info'>
                            ...
                            <div className='contact__card'>
                                ...
                                <span className='contact__card-data'>sharmadivyansh265@gmail.com</span>
                                <a href='mailto:sharmadivyansh265@gmail.com' className='contact__button'> Write me
                            ...
                            <div className='contact__card'>
                                ...
                                <span className='contact__card-data'>800-948-8902</span>
                                <a href='https://wa.link/u8zfe5' className='contact__button'> Write me
                                    <i className='bx bx-right-arrow-alt contact__button-icon '></i>
                                </a>
                            </div>
