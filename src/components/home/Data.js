...
function Data() {
    return (
        <div className='home__data'>
            <h1 className='home__title'>Divyansh Sharma
                <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
            ...
            <p className='home__description'>“There are three responses to a piece of design - yes, no, and WOW! Wow is the one to aim for”</p>
